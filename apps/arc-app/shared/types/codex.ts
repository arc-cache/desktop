 ...
 * This file provides convenience aliases and ARC-specific wrappers (e.g. _sessionId tags).
 */
...
export interface CodexArcMemoryNotification {
  method: "arc/memory";
  params: {
    id: string;
    title: string;
...
export type CodexSessionEvent = { _sessionId: string } & (CodexServerNotification | CodexAuthRequiredNotification | CodexArcMemoryNotification);
