...
const {
  ...
  mockApp: {
    ...
    getAppPath: vi.fn(() => "/Applications/ARC.app/Contents/Resources/app.asar"),
  },
  mockGetAppSetting: vi.fn(() => "ARC"),
...
describe("sdk path resolution", () => {
  beforeEach(() => {
    ...
    mockApp.getAppPath.mockReturnValue("/Applications/ARC.app/Contents/Resources/app.asar");
    mockGetAppSetting.mockReset();
    mockGetAppSetting.mockReturnValue("ARC");
  ...
  it("maps packaged app paths to app.asar.unpacked", async () => {
    ...
    expect(
      mod.resolveCliPathFromEntry(
        "/Applications/ARC.app/Contents/Resources/app.asar/node_modules/@anthropic-ai/claude-agent-sdk/embed.js",
        true,
      ),
    ).toBe(
      "/Applications/ARC.app/Contents/Resources/app.asar.unpacked/node_modules/@anthropic-ai/claude-agent-sdk/cli.js",
    );
  });
  ...
  it("falls back to the packaged app path only after SDK-based strategies fail", async () => {
    ...
    const packagedCliPath = "/Applications/ARC.app/Contents/Resources/app.asar.unpacked/node_modules/@anthropic-ai/claude-agent-sdk/cli.js";
