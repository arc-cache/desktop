...
const BUILTIN_COPILOT: InstalledAgent = {
  id: "copilot",
  name: "Copilot",
  engine: "copilot",
  builtIn: true,
  icon: "github",
  description: "GitHub Copilot through the native Copilot SDK, with ARC applied by the app turn lifecycle.",
};

const RETIRED_BUILTIN_IDS = ["arc-copilot"];
...
agents.set(BUILTIN_COPILOT.id, BUILTIN_COPILOT);
