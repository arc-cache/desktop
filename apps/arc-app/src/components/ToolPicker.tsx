...
import { Terminal, Globe, GitBranch, FileText, FolderTree, ListTodo, Bot, Plug, SquareArrowOutUpRight, ArrowDown, ArrowRight, Database, UsersRound } from "lucide-react";
...
const TOOL_TINTS: Record<string, { idle: string; hover: string; active: string }> = {
  ...
  memory:          { idle: "text-yellow-600/70 dark:text-yellow-200/50",    hover: "hover:text-yellow-600/90 dark:hover:text-yellow-200/70",   active: "text-yellow-600 dark:text-yellow-200/90" },
  sharing:         { idle: "text-cyan-600/70 dark:text-cyan-200/50",        hover: "hover:text-cyan-600/90 dark:hover:text-cyan-200/70",       active: "text-cyan-600 dark:text-cyan-200/90" },
...
export const PANEL_TOOLS_MAP: Record<string, ToolDef> = {
  ...
  sharing: { id: "sharing", label: "Sharing", icon: UsersRound },
};
