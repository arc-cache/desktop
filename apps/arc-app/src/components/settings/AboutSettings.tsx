...
// ── ARC logo mark — a stylized "H" rendered inline ──
      ...
      <ScrollArea className="min-h-0 flex-1">
        <div className="px-6 py-5">
          ...
          <div className="flex items-start gap-4">
            <ARCLogo className="h-12 w-12 shrink-0 text-foreground" />
            ...
            <div className="mt-3 rounded-xl border border-foreground/[0.06] bg-muted/20 px-4 py-3.5">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[13px] font-medium text-foreground/90">
                  Built by ARC contributors
                </span>
              </div>
              <p className="mt-1.5 text-xs leading-relaxed text-muted-foreground">
                ARC uses Apache-2.0 runtime code and MIT-licensed desktop app code.
