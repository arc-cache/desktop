...
export function ToolIslandContent({
  ...
  switch (toolId) {
    ...
    case "memory":
      return <MemoryPanel workspace={projectPath ?? projectRoot ?? null} headerControls={headerControls} />;
    case "sharing":
      return <SharingPanel workspace={projectPath ?? projectRoot ?? null} headerControls={headerControls} />;
    case "mcp":
      return (
        <McpPanel
          projectId={projectId}
