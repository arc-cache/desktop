...
2. Create the file \`${WORKTREE_SETUP_PATH}\` with the appropriate setup commands
...
Expected format for \`${WORKTREE_SETUP_PATH}\`:
\`\`\`json
{
  "setup-worktree": [
    "pnpm install",
...
Analyze this project now and create the \`${WORKTREE_SETUP_PATH}\` file.`;
      ...
      {isVisible && (
        ...
        >
          <div className="flex flex-col gap-1.5">
            ...
            {/* Setup file notification — persistent until a worktree setup config exists */}
            {hasSetupFile === false && (
