...
export type ProviderPermissionOptionKind =
  | "allow_once"
  | "allow_always"
  | "reject_once"
  | "reject_always"
...
export interface ProviderPermissionOption {
  id: string;
  label: string;
  kind: ProviderPermissionOptionKind;
}
...
export interface PermissionRequest {
  ...
  /**
   * Provider-native permission choices. When present, the UI must render and
   * submit one of these exact option IDs instead of inventing generic actions.
   */
  providerOptions?: ProviderPermissionOption[];
