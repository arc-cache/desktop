...
export type ToolId = "terminal" | "browser" | "git" | "files" | "project-files" | "tasks" | "agents" | "mcp" | "memory" | "sharing";

/** Subset of ToolId that renders as a panel in the tools column (excludes contextual tools like tasks/agents). */
export type PanelToolId = Extract<ToolId, "terminal" | "browser" | "git" | "files" | "project-files" | "mcp" | "memory" | "sharing">;
